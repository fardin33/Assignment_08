...
Users can browse products freely, but product details are protected. If a user is not logged in, they are redirected to the login page. After successful login, they can access the product details page.

**BetterAuth Authentication System:**
SunCart includes login, register, and Google social login using BetterAuth. Users can register with name, email, photo URL, and password, then login securely and access protected routes.
