      ...
      <AnimatePresence>
        {isLoggingOut && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-9999 flex items-center justify-center bg-teal-950/80 px-4 text-white backdrop-blur-xl"
          >
            <motion.div
              ...
              transition={{ duration: 0.25 }}
              className="flex w-full max-w-xs flex-col items-center rounded-3xl border border-white/10 bg-white/10 px-8 py-7 text-center shadow-2xl backdrop-blur-2xl"
            >
              <Lottie
          ...
          <div className="flex items-center gap-2">
            ...
            {session ? (
              <button
                ...
                className="hidden h-10 rounded-full bg-white/10 px-5 text-sm font-bold text-white backdrop-blur-md transition hover:bg-teal-800 disabled:cursor-not-allowed disabled:opacity-60 md:block"
              >
                  ...
                  <div className="mt-auto border-t border-white/10 pt-4">
                    {session ? (
                      <button
                        onClick={logout}
                        disabled={isLoggingOut}
                        className="w-full rounded-2xl bg-amber-400 px-4 py-3 text-sm font-extrabold text-teal-900 transition hover:bg-amber-300 disabled:cursor-not-allowed disabled:opacity-60"
                      >
                        {isLoggingOut ? "Logging out..." : "Logout"}
                      </button>
                    ) : (
